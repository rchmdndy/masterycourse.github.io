                    ...
                    ui.onDialogShown(self.$dialog, function () {
                        ...
                        $.get(imageListOptions.endpoint, null, null, "json").done(function (data) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                content.push(['<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">', '<div class="image-list-item">', '<img src="' + thumbUrlPrefix + '/' + data[i] + '" data-filename="' + data[i] + '" data-full-url="' + fullUrlPrefix + data[i] + '">', '<p>' + data[i] + '</p>', '</div>', '</div>'].join(""));
